Ext.define('App.pages.Area_country.Main', function(){
	var Variable = {};
	Variable.storeobj = Ext.create('App.store.Area_country');
		...
		tbar 		: [
			{
				...
				items: [
					{
						...
						iconAlign	: 'top',
						handler 	: function(a) {
							Ext.create('App.pages.Area_country.Form', {
								fbar    : [
									{
										xtype   : 'button',
										text    : 'Save',
										handler : function(btn){
											...
											*/
											Ext.Ajax.request({
												method: 'post',
												url: url+"app/C_area_country/save",
												waitTitle: 'Connecting',
												waitMsg: 'Sending data...',
												params: {
													id 			: win.items.items[0].value,
													country_name: win.items.items[1].value,
				...
				items : [
					Variable.grid = Ext.create('Ext.grid.Panel', {
						...
						columns: [
							{ header: 'Negara', flex : 1, dataIndex: 'country_name', editor : 'textfield'},
			                {
			                    header 		: 'Activate',
									...
									Ext.create('App.pages.Area_country.Form', {
										fbar    : [
											{
												...
												handler : function(btn){
													...
													Ext.Ajax.request({
														method: 'post',
														url: url+"app/C_area_country/update",
														waitTitle: 'Connecting',
														waitMsg: 'Sending data...',
														params: {
															id 			: win.items.items[0].value,
										...
										listeners: {
											show: function(thisForm){
												...
												thisForm.items.items[0].setValue(index.data.country_id);
												thisForm.items.items[1].setValue(index.data.country_name);

...
Ext.define('App.pages.App_user.Index', {
	...
	tbar 		: [
		{
			...
			items: [
				...
				},
				{
					...
					iconAlign	: 'top',
					handler 	: function(a) {
						Ext.create('App.pages.App_user.Search',{
	...
	items : [
		pageAppRole.grid = Ext.create('Ext.grid.Panel', {
			...
			columns: [
				{ header: 'User code',  dataIndex: 'user_code', width : 200,  editor : 'textfield'},
				{ header: 'Last login',  dataIndex: 'last_login_on', flex : 1,  editor : 'textfield'},
                {
                    header: 'Activate',
	...
	initComponent:function(){
		// pageAppRole.getStore(pageAppRole.paramsCriteria, 0, 25);
		// Ext.getCmp('main.tabC_app_user').setLoading(false);
		this.callParent();
	},
	listeners: {

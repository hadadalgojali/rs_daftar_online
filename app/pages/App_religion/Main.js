Ext.define('App.pages.App_religion.Main', function(){
	var Variable = {};
	Variable.storeobj = Ext.create('App.store.App_religion');
		...
		tbar 		: [
			{
				...
				items: [
					{
						...
						iconAlign	: 'top',
						handler 	: function(a) {
							Ext.create('App.pages.App_religion.Form', {
								fbar    : [
									{
										xtype   : 'button',
										text    : 'Save',
										handler : function(btn){
											...
											*/
											Ext.Ajax.request({
												method: 'post',
												url: url+"app/C_app_religion/save",
												waitTitle: 'Connecting',
												waitMsg: 'Sending data...',
												params: {
													id 			: win.items.items[0].value,
													religion 	: win.items.items[1].value,
								...
								handler 	: function(a) {
									...
									Ext.MessageBox.confirm('Delete', 'Apa anda yakin untuk menghapus ?', function(btn){
										if(btn === 'yes'){
											Ext.Ajax.request({
												method      : 'post',
												url         : url+"app/C_app_religion/delete",
												waitTitle   : 'Connecting',
												waitMsg     : 'Sending data...',
												params      : {
				...
				items : [
					Variable.grid = Ext.create('Ext.grid.Panel', {
						...
						columns: [
							{ header: 'Agama',  dataIndex: 'religion', flex : 1, editor : 'textfield'},
			                {
			                    header: 'Activate',
									...
									Ext.create('App.pages.App_religion.Form', {
										fbar    : [
											{
												...
												handler : function(btn){
													...
													Ext.Ajax.request({
														method: 'post',
														url: url+"app/C_app_religion/update",
														waitTitle: 'Connecting',
														waitMsg: 'Sending data...',
														params: {
															id 			: win.items.items[0].value,
										...
										listeners: {
											show: function(thisForm){
												...
												thisForm.items.items[1].setValue(index.data.religion);

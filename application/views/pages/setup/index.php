										...
										<div class="card-body">
											<div class="row">
												<div class="col-md-12 mb-3">
													<h5>Konfigurasi Data Rumah Sakit</h5>
												</div>
												<?php  
													foreach ($config_db['rs'] as $key => $value) {
														?>
														<div class="col-md-12 mb-3">
															<div class="input-group">
																...
																<input type="text" class="form-control" id="<?php echo "rs#".$key; ?>" name="<?php echo "rs#".$key; ?>" placeholder="" value="<?php echo $value; ?>">
															</div>
														</div>
														<?php
													}
												...
												<hr>
												<div class="col-md-12 mb-3">
													<h5>Konfigurasi Database MySQL</h5>
												</div>
												<?php  
													foreach ($config_db['default'] as $key => $value) {
														?>
														<div class="col-md-12 mb-3">
															<div class="input-group">
																<div class="input-group-prepend">
																	<span class="input-group-text" style="width: 200px;"><b>(Mysql)</b> <?php echo " ".strtoupper($key); ?></span>
																</div>
																<input type="text" class="form-control" id="<?php echo "default#".$key; ?>" name="<?php echo "default#".$key; ?>" placeholder="" value="<?php echo $value; ?>">
															</div>
														</div>
														<?php
													}
												...
												<hr>
												<div class="col-md-12 mb-3">
													<h5>Konfigurasi Database Secondary (SIM RS)</h5>
												</div>
												<?php  
													foreach ($config_db['second'] as $key => $value) {
														?>
														<div class="col-md-12 mb-3">
															<div class="input-group">
																<div class="input-group-prepend">
																...
																<input type="text" class="form-control" id="<?php echo "second#".$key; ?>" name="<?php echo "second#".$key; ?>" placeholder="" value="<?php echo $value; ?>" required>
															</div>
														</div>
														<?php
													}
